function recordDailyActivty(){
  var db = ScriptDb.getMyDb();

  var date1 = new Date();
  var date2 = new Date();
  var today = Utilities.formatDate(new Date(date1.setDate(date1.getDate() +0)), "America/New_York", "yyyy-MM-dd");
  var tomorrow = Utilities.formatDate(new Date(date2.setDate(date2.getDate() + 1)), "America/New_York", "yyyy-MM-dd"); 
